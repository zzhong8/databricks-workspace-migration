...
# display(data_over_threshold)

# COMMAND ----------

data_over_threshold = data_over_threshold.fillna({'ON_HAND_INVENTORY_QTY':0, 'RECENT_ON_HAND_INVENTORY_QTY':'0', 'RECENT_ON_HAND_INVENTORY_DIFF':'0'})
...
# display(data_with_final_features)
