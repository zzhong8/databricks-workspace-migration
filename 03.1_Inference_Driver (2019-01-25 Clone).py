...
champions_MODEL_METADATA = champions.select("MODEL_METADATA")

champions_MODEL_METADATA_distinct = champions_MODEL_METADATA.distinct()

# COMMAND ----------

# MAGIC %sql
# MAGIC select distinct MODEL_METADATA from champions

# COMMAND ----------

display(champions_MODEL_METADATA_distinct)
