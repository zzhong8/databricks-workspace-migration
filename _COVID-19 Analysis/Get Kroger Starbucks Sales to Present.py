...
# Read POS data
data_vault_data_2022 = read_pos_data(SOURCE_SYSTEM, RETAILER, CLIENT, COUNTRY_CODE, sqlContext).repartition('SALES_DT')
data_vault_data_2022 = data_vault_data_2022.where((pyf.col("SALES_DT") < pyf.lit("2022-08-01")) & (pyf.col("SALES_DT") >= pyf.lit("2022-01-01")))

total_sales_by_date_2022 = data_vault_data_2022.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_sales_by_date_2022)
