...
data_vault_data1_2019 = data_vault_data1.where((pyf.col("SALES_DT") < pyf.lit("2019-08-12")) & (pyf.col("SALES_DT") >= pyf.lit("2019-01-01")))
...
data_vault_data1_2020 = data_vault_data1.where((pyf.col("SALES_DT") < pyf.lit("2020-08-12")) & (pyf.col("SALES_DT") >= pyf.lit("2020-01-01")))
