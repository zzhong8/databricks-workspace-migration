...
data_vault_data1_2019 = data_vault_data1.where((pyf.col("SALES_DT") < pyf.lit("2019-12-31")) & (pyf.col("SALES_DT") >= pyf.lit("2019-01-01")))

total_sales_by_date1_2019 = data_vault_data1_2019.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_sales_by_date1_2019)

# COMMAND ----------

total_inventory_by_date1_2019 = data_vault_data1_2019.select("SALES_DT", "ON_HAND_INVENTORY_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_inventory_by_date1_2019)

# COMMAND ----------

data_vault_data1_2020 = data_vault_data1.where((pyf.col("SALES_DT") < pyf.lit("2020-09-12")) & (pyf.col("SALES_DT") >= pyf.lit("2020-01-01")))

total_sales_by_date1_2020 = data_vault_data1_2020.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_sales_by_date1_2020)

# COMMAND ----------

total_inventory_by_date1_2020 = data_vault_data1_2020.select("SALES_DT", "ON_HAND_INVENTORY_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_inventory_by_date1_2020)
...
input_data_list =  [('walmart', 'barillaamericainc', 'us')]
