...
SOURCE_SYSTEM1 = 'retaillink'
RETAILER1 = 'walmart'
CLIENT1 = 'minutemaidcompany'
COUNTRY_CODE1 = 'ca'
...
# MAGIC %sql
# MAGIC use retaillink_walmart_minutemaidcompany_ca_dv;
# MAGIC
# MAGIC show tables
...
# MAGIC %sql
# MAGIC desc retaillink_walmart_minutemaidcompany_ca_dv.sat_retailer_item

# COMMAND ----------

# MAGIC
# MAGIC %sql
# MAGIC desc retaillink_walmart_minutemaidcompany_ca_dv.vw_latest_sat_retailer_item

# COMMAND ----------

# MAGIC %sql
# MAGIC desc retaillink_walmart_minutemaidcompany_ca_dv.vw_latest_sat_epos_summary

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from retaillink_walmart_minutemaidcompany_ca_dv.vw_latest_sat_epos_summary
# MAGIC where sales_dt <= '2024-12-31'
# MAGIC and sales_dt >= '2024-01-01'
# MAGIC and retailer_item_id in 
# MAGIC (30128500,
# MAGIC 30145228,
# MAGIC 30145230,
# MAGIC 30145239,
...
# MAGIC %sql
# MAGIC select a.RETAILER_ITEM_ID, b.RETAILER_ITEM_desc, count(distinct ORGANIZATION_UNIT_NUM) as num_stores_with_POS_data, count(distinct ORGANIZATION_UNIT_NUM) as num_2024_days_POS_data from retaillink_walmart_minutemaidcompany_ca_dv.vw_latest_sat_epos_summary a join vw_latest_sat_retailer_item b on a.retailer_item_id = b.RETAILER_ITEM_ID
# MAGIC where sales_dt <= '2024-12-31'
# MAGIC and sales_dt >= '2024-01-01'
# MAGIC group by a.RETAILER_ITEM_ID, b.RETAILER_ITEM_desc
# MAGIC order by a.RETAILER_ITEM_ID, b.RETAILER_ITEM_desc

# COMMAND ----------

# Read POS data
data_vault_data1 = read_pos_data(SOURCE_SYSTEM1, RETAILER1, CLIENT1, COUNTRY_CODE1, sqlContext).repartition('SALES_DT')
data_vault_data1 = data_vault_data1.where((pyf.col("SALES_DT") < pyf.lit("2024-08-01")) & (pyf.col("SALES_DT") >= pyf.lit("2024-01-01")))
...
input_data_list =  [('walmart', 'lego', 'ca')]
