...
# MAGIC %sql
# MAGIC
# MAGIC select * from retail_alert_kroger_barilla_us_im.DRFE_FORECAST_BASELINE_UNIT

# COMMAND ----------

# Read POS data
data_vault_data1 = read_pos_data(SOURCE_SYSTEM, RETAILER, CLIENT, COUNTRY_CODE, sqlContext).repartition('SALES_DT')
data_vault_data1 = data_vault_data1.where((pyf.col("SALES_DT") < pyf.lit("2022-08-01")) & (pyf.col("SALES_DT") >= pyf.lit("2022-01-01")))
