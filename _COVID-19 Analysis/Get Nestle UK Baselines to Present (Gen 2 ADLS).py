...
# MAGIC %sql
# MAGIC
# MAGIC select * from retail_alert_asda_nestlecore_uk_im.drfe_forecast_baseline_unit

# COMMAND ----------

df_sql_query_asda_nestle = """
    select SALES_DT, BASELINE_POS_ITEM_QTY from retail_alert_asda_nestlecore_uk_im.drfe_forecast_baseline_unit
...
df_sql_query_morrisons_nestle = """
    select SALES_DT, BASELINE_POS_ITEM_QTY from retail_alert_morrisons_nestlecore_uk_im.drfe_forecast_baseline_unit
    where SALES_DT >= '2022-01-01'
    order by SALES_DT
"""
...
df_sql_query_sainsburys_nestle = """
    select SALES_DT, BASELINE_POS_ITEM_QTY from retail_alert_sainsburys_nestlecore_uk_im.drfe_forecast_baseline_unit
    where SALES_DT >= '2022-01-01'
    order by SALES_DT
"""
...
df_sql_query_tesco_nestle = """
    select SALES_DT, BASELINE_POS_ITEM_QTY from retail_alert_tesco_nestlecore_uk_im.drfe_forecast_baseline_unit
    where SALES_DT >= '2022-01-01'
    order by SALES_DT
"""
