...
# Read POS data
data_vault_data_2023 = read_pos_data(SOURCE_SYSTEM, RETAILER, CLIENT, COUNTRY_CODE, sqlContext).repartition('SALES_DT')
data_vault_data_2023 = data_vault_data_2023.where((pyf.col("SALES_DT") < pyf.lit("2023-12-31")) & (pyf.col("SALES_DT") >= pyf.lit("2022-07-01")))

total_sales_by_date_2023 = data_vault_data_2023.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_sales_by_date_2023)

# COMMAND ----------

# Read POS data
data_vault_data_2023_2 = data_vault_data_2023.where(pyf.col("ON_HAND_INVENTORY_QTY").isNotNull())

total_sales_by_date_2023_2 = data_vault_data_2023_2.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").sum()

display(total_sales_by_date_2023_2)
...
count_sales_by_date_2023_2 = data_vault_data_2023_2.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").count()

display(count_sales_by_date_2023_2)

# COMMAND ----------

# Read POS data
data_vault_data_2023_3 = data_vault_data_2023.where(pyf.col("ON_HAND_INVENTORY_QTY").isNull())

count_sales_by_date_2023_3 = data_vault_data_2023_3.select("SALES_DT", "POS_ITEM_QTY").orderBy("SALES_DT").groupBy("SALES_DT").count()

display(count_sales_by_date_2023_3)

# COMMAND ----------

data_vault_data_2023_01_29 = data_vault_data_2023_2.where(pyf.col("SALES_DT") == pyf.lit("2023-01-29"))

display(data_vault_data_2023_01_29)

# COMMAND ----------

data_vault_data_zero_sales = data_vault_data_2022.where(pyf.col('POS_ITEM_QTY') == 0)

# COMMAND ----------

display(data_vault_data_zero_sales)

# COMMAND ----------

count_sales_by_store_item_2022 = data_vault_data_2022.select("ORGANIZATION_UNIT_NUM", "RETAILER_ITEM_ID").orderBy("ORGANIZATION_UNIT_NUM", "RETAILER_ITEM_ID").groupBy("ORGANIZATION_UNIT_NUM", "RETAILER_ITEM_ID").count()
