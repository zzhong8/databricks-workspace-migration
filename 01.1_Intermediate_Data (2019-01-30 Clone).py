...
pay_cycles = spark.read.format('csv')\
    ...
    .load('/mnt/artifacts/reference/pay_cycle_profiles_by_state.csv')
...
snap_pay_cycle_path = '/mnt/prod-ro/artifacts/reference/snap_paycycle/retailer={retailer}/client={client}/'
stores_with_pc.write.mode('overwrite').parquet(snap_pay_cycle_path.format(retailer=RETAILER, client=CLIENT))

# COMMAND ----------

# Filtering and save the data set
