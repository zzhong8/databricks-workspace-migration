...
# Import only recent data (currently set to most recent 21 months)
today_date = datetime.date.today()
min_date = today_date - relativedelta(months=21)
...
# Temp fix for Asda Beiersdorf IVM Data 2024-08-06
...
#         FROM
#             acosta_retail_analytics_im.ds_intervention_summary_20240806_asda_beiersdorf_loess_ivm_test
#         WHERE
#             is_complete = true
#             AND mdm_client_id = {client_id}
#     """
...
# %sql
# create table if not exists acosta_retail_analytics_im.ds_intervention_audit_raw
# (
#   mdm_country_id  Int,
#   mdm_holding_id  Int,
#   mdm_banner_id Int,
...
#   intervention_start_day  Integer,
#   intervention_end_day  Integer,
#   actionable_flg  Boolean,
#   status_code  String,
#   audit_ts  Timestamp
# )
# USING delta
# tblproperties (delta.autooptimize.optimizewrite = true, delta.autooptimize.autocompact = true)
# LOCATION 'abfss://data@eus2psag2dpcoredatalake.dfs.core.windows.net/informationmart/acosta_retail_report/ds_intervention_audit_raw'
...
# MAGIC create table if not exists acosta_retail_analytics_im.ds_intervention_summary_20240806_asda_beiersdorf_loess_ivm_test 
# MAGIC (
...
# MAGIC LOCATION 'abfss://data@eus2psag2dpcoredatalake.dfs.core.windows.net/informationmart/acosta_retail_report/ds_intervention_summary_20240806_asda_beiersdorf_loess_ivm_test'
...
delta_summary_table = DeltaTable.forName(
    spark, "acosta_retail_analytics_im.ds_intervention_summary_20240806_asda_beiersdorf_loess_ivm_test"
).alias("source")
