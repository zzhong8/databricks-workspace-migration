...
df1a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-kraftheinz-post-2019-10-15-sales-old-predictions')
...
df1b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-kraftheinz-post-2019-12-01-sales-old-predictions')
...
df2a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-nestlecereals-post-2019-10-15-sales-new-predictions')
...
df2b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-nestlecereals-post-2019-12-01-sales-new-predictions')
...
df3a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-kraftheinz-post-2019-10-15-sales-old-predictions')
...
df3b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-kraftheinz-post-2019-12-01-sales-old-predictions')
...
df4a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-10-15-sales-old-predictions')
...
df4b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-12-01-sales-old-predictions')
...
df5a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-kraftheinz-post-2019-10-15-sales-old-predictions')
...
df5b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-kraftheinz-post-2019-12-01-sales-old-predictions')
...
df6a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-nestlecereals-post-2019-10-15-sales-old-predictions')
...
df6b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-nestlecereals-post-2019-12-01-sales-old-predictions')
...
df7a.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/sainsburys-kraftheinz-post-2019-10-15-sales-old-predictions')
...
df7b.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/sainsburys-kraftheinz-post-2019-12-01-sales-old-predictions')
...
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/sainsburys-nestlecereals-post-2019-10-15-sales-old-predictions')
...
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/sainsburys-nestlecereals-post-2019-12-01-sales-old-predictions')
