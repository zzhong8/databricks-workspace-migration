...
PATH_RESULTS_INPUT1 = '/mnt/artifacts/hugh/asda-kraftheinz-post-2019-12-01-sales-new-predictions'
...
df1_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-kraftheinz-post-2019-12-01-sales-new-predictions-agg')
...
df1_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-kraftheinz-agg-top-selling-items-new')
...
PATH_RESULTS_INPUT2 = '/mnt/artifacts/hugh/asda-nestlecereals-post-2019-12-01-sales-newer-predictions'
...
df2_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-nestlecereals-post-2019-12-01-sales-newer-predictions-agg')
...
df2_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/asda-nestlecereals-agg-top-selling-items-new')
...
PATH_RESULTS_INPUT3 = '/mnt/artifacts/hugh/tesco-kraftheinz-post-2019-12-01-sales-new-predictions'
...
df3_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-kraftheinz-post-2019-12-01-sales-new-predictions-agg')
...
df3_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-kraftheinz-agg-top-selling-items-new')
...
PATH_RESULTS_INPUT4 = '/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-12-01-sales-new-predictions'
...
df4_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-12-01-sales-new-predictions-agg')
...
df4_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/tesco-nestlecereals-agg-top-selling-items-new')
...
PATH_RESULTS_INPUT5 = '/mnt/artifacts/hugh/morrisons-kraftheinz-post-2019-12-01-sales-new-predictions'
...
df5_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-kraftheinz-post-2019-10-15-sales-new-predictions-agg')
...
df5_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-kraftheinz-agg-top-selling-items-new')
...
PATH_RESULTS_INPUT6 = '/mnt/artifacts/hugh/morrisons-nestlecereals-post-2019-12-01-sales-new-predictions'
...
df6_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-nestlecereals-post-2019-12-01-sales-new-predictions-agg')
...
df6_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/morrisons-nestlecereals-agg-top-selling-items-new')
...
PATH_RESULTS_INPUT7 = '/mnt/artifacts/hugh/sainsburys-kraftheinz-post-2019-12-01-sales-new-predictions'
...
df7_agg.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/sainsburys-kraftheinz-post-2019-12-01-sales-new-predictions-agg')
...
df7_agg_top_selling_items_desc.coalesce(1)\
    ...
    .option('header', 'true')\
    .mode('overwrite')\
    .save('/mnt/artifacts/hugh/sainsburys-kraftheinz-agg-top-selling-items-new')
