...
# MAGIC %md ## 0. Grab the example dataset
...
# MAGIC %md ##1. Read the data into a Spark dataframe and write as a Delta table
...
# MAGIC %md ## 2. Feature Engineering in Spark
...
# MAGIC %md ## 3. Write out the Training and Testing data for future reference
