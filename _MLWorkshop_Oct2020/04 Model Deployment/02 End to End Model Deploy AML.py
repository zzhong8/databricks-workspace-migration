...
# MAGIC %md ### Note that the notebook will not run on the training environment as we don't have the ACS, AKS etc services available

# COMMAND ----------

# MAGIC %md
# MAGIC The dataset used for this example is the UCI ML repository wine ratings dataset on the quality of wines.
# MAGIC
# MAGIC Original Source: [UCI Machine Learning Repository 
# MAGIC Wine Ratings Data Set](https://archive.ics.uci.edu/ml/datasets/wine+quality)
# MAGIC [Cortez et al., 2009] 
