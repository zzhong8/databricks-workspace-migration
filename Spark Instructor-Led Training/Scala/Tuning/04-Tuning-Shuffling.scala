...
val numberPartitions = <<FILL_IN>>
val dfSize = 591.5 // from Spark UI: Change this, if it's wrong.
val dfPartitionSize = <<FILL_IN>>
...
val executorCount =  <<FILL_IN>>
val newPartitionSize = <<FILL_IN>>
val defaultParallelism = <<FILL_IN>>
val numPartitions = <<FILL_IN>>
println(s"New partition count: $numPartitions")

val repartitionedDF = <<FILL_IN>>
