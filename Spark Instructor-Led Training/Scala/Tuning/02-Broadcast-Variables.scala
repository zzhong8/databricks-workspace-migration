...
// Convert the DataFrame to a Dataset so that lambdas and anonymous functions can be used.
val ds = <FILL_IN>
...
// TODO
for (i <- 1 to 5) ds.map { /*TODO*/ }.count()
...
// TODO 
// remove broadcast variable from memory of executors and driver.
