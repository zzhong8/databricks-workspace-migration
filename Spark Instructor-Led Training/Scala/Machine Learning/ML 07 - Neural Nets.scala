...
val testFixedDF = testDF.select('label, <FILL_IN>)
...
// TODO: Replace <FILL_IN> with appropriate code
val indexer = new StringIndexer().<FILL_IN>

// Set the label column
val mlp = new MultilayerPerceptronClassifier().<FILL_IN>

mlp.setLayers(<FILL_IN>) // 780 inputs, two hidden layers (20 and 10 neurons, respectively) and output layer of 10 neurons
