...
val gbt = new GBTRegressor().<FILL_IN>
...
val evaluator = new RegressionEvaluator()
                    .setMetricName(<FILL_IN>)
                    .setLabelCol(<FILL_IN>)
                    .setPredictionCol(<FILL_IN>)

val cv = new CrossValidator()
            .setEstimator(<FILL_IN>)
            .setEvaluator(<FILL_IN>)
            .setEstimatorParamMaps(<FILL_IN>)
...
// TODO: Replace <FILL_IN> with appropriate code
val pipelineModel = pipeline.<FILL_IN>
...
// TODO: Replace <FILL_IN> with appropriate code
val predictionsDF = pipelineModel.<FILL_IN>
...
// TODO: Replace <FILL_IN> with appropriate code
val rmse = evaluator.evaluate(<FILL_IN>)
