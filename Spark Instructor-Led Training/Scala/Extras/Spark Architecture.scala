...
// MAGIC
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/images/title-diagram.png" style="margin-left: 20px; width: 300px; float: right"/>
...
// MAGIC %md-sandbox
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/images/spark-submit-driver.png" style="border: 1px solid #aaa; float: right; margin-left: 20px"/>
// MAGIC
...
// MAGIC
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/images/spark-jobs-databricks-1.png" alt="Jobs drop-down" style="border: 1px solid #aaa"/>
// MAGIC
...
// MAGIC
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/images/spark-jobs-databricks-2.png" alt="Jobs drop-down" style="border: 1px solid #aaa; width: 300px"/>
// MAGIC
...
// MAGIC
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/wiki-book/pageviews/pipelining.png" style="float: right"/>
// MAGIC
...
// MAGIC
// MAGIC ![Catalyst Optimizer](https://s3-us-west-2.amazonaws.com/curriculum-release/wiki-book/pageviews/catalyst.png)
...
// MAGIC
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/images/predicate-pushdown-1.png" style="border: 1px solid #aaa; margin: 20px; width: 600px"/>
// MAGIC
// MAGIC But, Catalyst will fix that for us automatically:
// MAGIC
// MAGIC <img src="https://s3-us-west-2.amazonaws.com/curriculum-release/images/predicate-pushdown-2.png" style="border: 1px solid #aaa; margin: 20px; width: 600px"/>
...
import org.apache.spark.sql.functions._
val peopleDF = spark.read.option("header", "true").option("inferSchema", "true").option("delimiter", ":").csv("dbfs:/mnt/training/dataframes/people-with-header-10m.txt") // first DataFrame
