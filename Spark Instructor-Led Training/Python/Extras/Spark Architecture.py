...
from pyspark.sql.functions import *
people_df = spark.read.option("header", "true").option("inferSchema", "true").option("delimiter", ":").csv("dbfs:/mnt/training/dataframes/people-with-header-10m.txt") # first DataFrame
