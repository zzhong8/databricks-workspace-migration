...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Entry Points
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) SparkSession
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) DataFrameReader
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Reading from CSV w/InferSchema
# MAGIC
...
# MAGIC * We still have three columns
# MAGIC * All three columns are **NOT** nullable because we declared them as such. (NOT TRUE! See https://stackoverflow.com/questions/39917075/pyspark-structfield-false-always-returns-nullable-true-instead-of)
# MAGIC * All three columns have their proper names
