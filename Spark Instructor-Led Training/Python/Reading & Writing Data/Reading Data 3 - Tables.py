...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Registering Tables in Databricks
# MAGIC
...
file_location = "/mnt/training/wikipedia/pageviews/pageviews_by_second.tsv"
file_type = "csv"
...
temp_table_name = "pageviews_by_second_example_tsv"
...
permanent_table_name = "pageviews_by_second_example_tsv"
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Reading from a Table/View
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Temporary Views
# MAGIC
