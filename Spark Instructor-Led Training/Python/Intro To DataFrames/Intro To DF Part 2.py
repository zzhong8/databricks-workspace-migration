...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) orderBy(..) & sort(..)
# MAGIC
...
print("columnC: %s" % columnC)
print("columnD: %s" % columnD)
print("columnE: %s" % columnE)
...
# MAGIC
# MAGIC What if we only one to look at the main Wikipedia project, **en**?
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) filter(..) & where(..)
...
topTenDF.show(10, False)

# COMMAND ----------

# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) first() & head()
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) The Row Class
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) DataFrame vs Dataset
# MAGIC
...
# MAGIC
# MAGIC val topTenDF = spark                            // Our SparkSession & Entry Point
...
# MAGIC %md
# MAGIC Notice above that `topTenDF` is a `Dataset` of type `Row`.
# MAGIC
...
# MAGIC %scala
# MAGIC
# MAGIC val topTenDS = topTenDF.as[WikiReq]
...
# MAGIC %scala
# MAGIC val wikiReqs = topTenDS.take(10)
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/labs.png) Data Frames Lab #2
