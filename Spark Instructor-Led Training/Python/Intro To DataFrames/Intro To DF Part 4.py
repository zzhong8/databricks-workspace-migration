...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) date_format()
# MAGIC
...
# MAGIC
# MAGIC One of the functions that can help us with this is the operation `date_format(..)` from the `functions` package.
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) User Defined Functions (UDF)
# MAGIC
...
# MAGIC %md
# MAGIC
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) I Lied
# MAGIC
...
# MAGIC %md
# MAGIC
# MAGIC See also <a href="https://docs.databricks.com/spark/latest/spark-sql/udaf-scala.html" target="_blank">User Defined Aggregate Functions</a>.

# COMMAND ----------

# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) What About Mondays?
# MAGIC
...
# MAGIC
# MAGIC But even more importantly, one graph is really just a semi-contrived reason to demonstrate a `join(..)` operation.
...
# MAGIC %md
# MAGIC
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) join(..)
# MAGIC
...
# MAGIC %md
# MAGIC
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) More Conclusions?
# MAGIC   
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/labs.png) Data Frames Lab #4
# MAGIC
