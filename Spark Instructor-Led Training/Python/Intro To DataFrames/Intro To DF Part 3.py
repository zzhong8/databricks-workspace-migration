...
# MAGIC %md-sandbox
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Preparing Our Data
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) withColumnRenamed(..), withColumn(..), select(..)
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) unix_timestamp(..) & cast(..)
...
# MAGIC
# MAGIC `SimpleDateFormat` is part of the Java API and provides support for parsing and formatting date and time values.
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) year(..), month(..), dayofyear(..)
# MAGIC
...
# MAGIC %md
# MAGIC How about the total count of rows per site? mobile vs desktop?
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) sum(), count(), avg(), min(), max()
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/labs.png) Data Frames Lab #3
