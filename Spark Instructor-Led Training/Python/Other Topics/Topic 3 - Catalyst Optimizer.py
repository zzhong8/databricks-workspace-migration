...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Catalyst Optimizer
# MAGIC
...
# MAGIC %md
# MAGIC
# MAGIC ![Catalyst](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/catalyst-diagram.png)

# COMMAND ----------

# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Optimized Logical Plan
# MAGIC
...
innocentDF.explain(True) # extended – boolean, default False. If False, prints only the physical plan.
...
betterDF.explain(True) # If True then prints: 1) Parsed Logical Plan 2) Analyzed Logical Plan 3) Optimized Logical Plan 4) Physical Plan
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Columnar Predicate Pushdown
# MAGIC
...
# MAGIC * the presence of **PushedFilters** in the **Scan**
