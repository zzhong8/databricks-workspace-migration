...
# MAGIC * With 192.6 MB of data divided into 8 partitions...
...
# MAGIC
# MAGIC `cache()` is just an alias for `persist()` or `persist(MEMORY_AND_DISK)` if the object being persisted is a dataframe
# MAGIC
