...
# MAGIC %md-sandbox
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) My First Steps
# MAGIC
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Partitions vs Slots
# MAGIC
...
# MAGIC ### Slots/Cores
# MAGIC
# MAGIC * If you recall from earlier, we are running on a version of Apache Spark that is...
# MAGIC   * running in Local Mode - **Driver** and **Executor** share the same JVM
# MAGIC   * we have 6 GB allocated to our one JVM
# MAGIC   * we have eight **slots** for parallel execution
# MAGIC
# MAGIC ![Notebook + Micro Cluster](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/notebook_microcluster.png)
# MAGIC
# MAGIC <br/>
# MAGIC
# MAGIC * On another cluster, these details will change.
# MAGIC * Of all of those details, the only thing that one needs to be concerned with [currently] is the number of slots available for parallel execution.
# MAGIC
# MAGIC We can determine the number of **slots** via several different configuration parameters.
# MAGIC
# MAGIC This assumes the configuration parameters are even set.
# MAGIC
# MAGIC It's actually easier to just take a look at the **Executors** tab in the **Spark UI**. In this case we are looking for the number of **cores**.
# MAGIC
# MAGIC In the case of Databricks Community Edition, we know the answer will be 8.
...
# MAGIC ### Partitions
# MAGIC
# MAGIC * The second half of this question is how many partitions of data do I have?
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) repartition(n) or coalesce(n)
# MAGIC
...
# MAGIC %md-sandbox
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Cache, Again?
# MAGIC
# MAGIC Back to list...
# MAGIC 0. <div style="text-decoration:line-through">Read the data in</div>
...
# MAGIC %md-sandbox
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) spark.sql.shuffle.partitions
# MAGIC
# MAGIC 0. <div style="text-decoration:line-through">Read the data in</div>
# MAGIC 0. <div style="text-decoration:line-through">Balance the number of partitions to the number of slots</div>
...
# MAGIC %md-sandbox
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Initial ETL
# MAGIC
# MAGIC 0. <div style="text-decoration:line-through">Read the data in</div>
# MAGIC 0. <div style="text-decoration:line-through">Balance the number of partitions to the number of slots</div>
# MAGIC 0. <div style="text-decoration:line-through">Cache the data</div>
...
# MAGIC %md-sandbox
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) All Done
# MAGIC
# MAGIC 0. <div style="text-decoration:line-through">Read the data in</div>
# MAGIC 0. <div style="text-decoration:line-through">Balance the number of partitions to the number of slots</div>
# MAGIC 0. <div style="text-decoration:line-through">Cache the data</div>
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/labs.png) Partitioning Lab
