...
udf_make780 = spark.udf.register("make780", make780, VectorUDT())
...
mlp.setLayers([780, 20, 10, 10]) # 780 inputs, two hidden layers (20 and 10 neurons, respectively) and output layer of 10 neurons
...
savedModel = PipelineModel.load(userhome+"/NeuralNetPipeline.parquet")
