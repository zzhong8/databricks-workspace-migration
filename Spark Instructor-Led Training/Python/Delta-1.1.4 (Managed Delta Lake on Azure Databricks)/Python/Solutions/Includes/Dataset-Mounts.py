...
if course_name == "Spark ILT":
  # Using course_name is a temporary hack that will 
  # not scale to all the different ILT releases
  spark.conf.set("com.databricks.training.valid", "true")

elif spark.conf.get("com.databricks.training.job") == "true":
  spark.conf.set("com.databricks.training.valid", "true")
  
else:
  import base64
  s = ''
  c = base64.b64decode(s)
  eval(compile(c, '<string>', 'exec'))
