...
# MAGIC * Version:  **1.0.5**
# MAGIC * Built On: **Sep 18, 2023 at 14:00:02 UTC**
...
# MAGIC
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **11.3.x-cpu-ml-scala2.12, 12.2.x-cpu-ml-scala2.12**.
# MAGIC
