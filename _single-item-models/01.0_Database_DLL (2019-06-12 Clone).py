...
# MAGIC %sql
# MAGIC desc RETAIL_FORECAST_ENGINE.DRFE_FORECAST_BASELINE_UNIT

# COMMAND ----------

# MAGIC %sql
# MAGIC ALTER TABLE RETAIL_FORECAST_ENGINE.DRFE_FORECAST_BASELINE_UNIT CHANGE SALES_DT SALES_DT date AFTER MODEL_ID

# COMMAND ----------

# MAGIC %sql
# MAGIC desc walmart_dole_retail_alert_im.DRFE_FORECAST_BASELINE_UNIT
