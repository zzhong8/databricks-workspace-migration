...
select * from bobv2.Campaign where CompanyID = '560'
...
-- MAGIC          WHERE
-- MAGIC             p.CompanyId =560 and COALESCE(c.ParentChainId, c.ChainId)=950 
...
-- MAGIC where
-- MAGIC    ivp.CompanyId =560 ---filter on Each CompanyId 
