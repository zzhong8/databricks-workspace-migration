...
input_data_list = [('walmart', 'smuckers', 'ca')]
...
# MAGIC %sql
# MAGIC MERGE INTO RETAIL_FORECAST_ENGINE.PERFORMANCE MON
...
# MAGIC    AND MON.COUNTRY_CODE = RES.COUNTRY_CODE
...
# MAGIC   THEN INSERT (RETAILER_ITEM_ID, RETAILER_ITEM_DESC, RETAILER, CLIENT,
# MAGIC                 COUNTRY_CODE, ORGANIZATION_UNIT_NUM, SALES_DT, POS_ITEM_QTY,
# MAGIC                 POS_AMT, ON_HAND_INVENTORY_QTY, DRFE_POS_ITEM_QTY,
# MAGIC                 DRFE_ERROR, DRFE_LOAD_TS, MODEL_TYPE,
# MAGIC                 TEST_SET_MSE_PERFORMANCE,
# MAGIC                 High_Dollar_Sales, High_Frequency, Low_Frequency
# MAGIC               )
# MAGIC   VALUES (RES.RETAILER_ITEM_ID, RES.RETAILER_ITEM_DESC, RES.RETAILER, RES.CLIENT,
# MAGIC           RES.COUNTRY_CODE, RES.ORGANIZATION_UNIT_NUM, RES.SALES_DT, RES.POS_ITEM_QTY,
# MAGIC           RES.POS_AMT, RES.ON_HAND_INVENTORY_QTY, RES.DRFE_POS_ITEM_QTY,
# MAGIC           RES.DRFE_ERROR, RES.DRFE_LOAD_TS, RES.MODEL_TYPE,
# MAGIC           RES.TEST_SET_MSE_PERFORMANCE, RES.High_Dollar_Sales,
# MAGIC           RES.High_Frequency, RES.Low_Frequency
# MAGIC           )

# COMMAND ----------

# MAGIC %sql
# MAGIC OPTIMIZE RETAIL_FORECAST_ENGINE.PERFORMANCE
# MAGIC ZORDER BY RETAILER_ITEM_ID, SALES_DT
