...
df_inferred_filtered = df_inferred.filter((df_inferred.SALES_DT >= date(2019, 4, 1)) & (df_inferred.SALES_DT <= date(2019, 4, 30)))
...
df_inferred_filtered.coalesce(1) \
    ...
    .save('/mnt/artifacts/hugh/kraftheinz-sainsburys-predictions-190401-to-190430')
