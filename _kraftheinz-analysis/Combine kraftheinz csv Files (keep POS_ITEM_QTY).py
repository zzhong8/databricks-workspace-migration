...
df = spark.read.format('csv').option('header', 'true').load('/mnt/artifacts/hugh/all_predictions/*.csv')
...
df.coalesce(1) \
    ...
    .save('/mnt/artifacts/hugh/kraftheinz-all-predictions-190101-to-190514-withpos')
