...
# (TODO: 2019-08-23) save data_partitioned to csv

# Import approved product list for this client
training_df_reference_path = '/mnt/artifacts/hugh/client={client}/retailer={retailer}/'\
    .format(client=CLIENT, retailer=RETAILER)

# Save the data set
data_partitioned.coalesce(1) \
    .write.mode('overwrite').format('csv').option('header', 'true') \
    .save(training_df_reference_path)
