...
#         continue
    ...
    df_info = df_intervention_info[df_intervention_info['ProductNumber']==int(product_number)]
...
#     print(PATH_RESULTS_INPUT)
    ...
    #     print_shape(x_val)
        ...
        # PATHS (new!)
        PATH_RESULTS_OUTPUT = '/mnt/artifacts/hugh/kraftheinz-morrisons-intervention-measurement-results'
