...
data_vault_data1 = data_vault_data.where((col("SALES_DT") < lit("2019-05-01")) & (col("SALES_DT") >= lit("2019-03-31")))
data_vault_data2 = data_vault_data1.where((col("RETAILER_ITEM_ID") == ITEM))

# COMMAND ----------

data_vault_data3 = data_vault_data2.select('RETAILER', 'CLIENT', 'RETAILER_ITEM_ID', 'ORGANIZATION_UNIT_NUM', 'SALES_DT', 'POS_ITEM_QTY')
