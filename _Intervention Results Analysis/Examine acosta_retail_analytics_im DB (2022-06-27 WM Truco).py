...
country_id = 1  # US
client_id = 1950 # Truco Enterprise Dba Ot Border
...
# MAGIC where Retail_Client = 'walmart_trucoenterprisedbaotborder_us'
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT SALES_DT, count(*) FROM retail_alert_walmart_trucoenterprisedbaotborder_us_im.alert_on_shelf_availability
# MAGIC where SALES_DT >= '2022-06-11'
# MAGIC group by SALES_DT
# MAGIC order by SALES_DT
...
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_client_id = 1950 -- Truco Enterprise Dba Ot Border
# MAGIC and
# MAGIC mdm_holding_id = 71 -- Walmart
