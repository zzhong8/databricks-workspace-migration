...
# MAGIC %sql
# MAGIC
# MAGIC desc retail_alert_target_wildcat_us_im.alert_on_shelf_availability

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SELECT SALES_DT, count(*) FROM retail_alert_target_wildcat_us_im.alert_on_shelf_availability
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT * FROM retail_alert_target_wildcat_us_im.alert_on_shelf_availability

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SELECT SALES_DT, count(*) FROM retail_alert_target_wildcat_us_im.alert_inventory_cleanup
