...
# MAGIC %sql
# MAGIC desc msd_morrisons_bat_uk_dv.vw_latest_sat_epos_summary
...
# MAGIC %sql
# MAGIC show tables in msd_morrisons_bat_uk_dv

# COMMAND ----------

# MAGIC %sql
# MAGIC show tables in msd_morrisons_bat_uk_raw

# COMMAND ----------

# MAGIC %sql
# MAGIC desc msd_morrisons_bat_uk_raw.inventory

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from msd_morrisons_bat_uk_raw.inventory
# MAGIC limit 20

# COMMAND ----------

# MAGIC %sql
# MAGIC select distinct date from msd_morrisons_bat_uk_raw.inventory
# MAGIC group by date
# MAGIC order by date
...
# MAGIC %sql
# MAGIC select sales_dt, count(*) from msd_morrisons_bat_uk_dv.vw_latest_sat_epos_summary_ivm_temp
# MAGIC group by sales_dt
# MAGIC order by sales_dt
...
# MAGIC %sql
# MAGIC select * from msd_morrisons_bat_uk_dv.vw_latest_sat_epos_summary_ivm_temp
...
# MAGIC %sql
# MAGIC select count(*) from msd_morrisons_bat_uk_dv.vw_latest_sat_epos_summary
...
# MAGIC %sql
# MAGIC select count(*) from msd_morrisons_bat_uk_dv.vw_latest_sat_epos_summary_ivm_temp
# MAGIC where sales_dt >= '2023-01-01'
# MAGIC and sales_dt <= '2025-05-29'
