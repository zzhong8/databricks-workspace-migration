...
df_summary_table_2023_test = df_summary_table_test.where((pyf.col("call_date") < pyf.lit("2024-01-01")) & (pyf.col("call_date") >= pyf.lit("2023-01-01")))

print(f'{df_summary_table_2023_test.cache().count():,} Interventions in 2022')

df_summary_table_2023_test_all = df_summary_table_2023_test
