...
CREATE OR REPLACE VIEW acosta_retail_analytics_im.ds_intervention_summary_nestle_temp_20240714 AS
(
  SELECT mdm_banner_nm, standard_response_text, count(*) as num_responses FROM acosta_retail_analytics_im.ds_intervention_summary
  where
  mdm_country_id = 30 -- UK
...
select * from acosta_retail_analytics_im.ds_intervention_summary_nestle_temp_20240714
