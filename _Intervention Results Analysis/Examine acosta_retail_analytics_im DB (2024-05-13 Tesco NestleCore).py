...
# MAGIC %sql
# MAGIC
# MAGIC select sales_dt, count(*) from tescopartnertoolkit_tesco_nestlecore_uk_dv.vw_latest_sat_epos_summary
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT standard_response_text, count(*) FROM acosta_retail_analytics_im.ds_intervention_audit_raw
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC and
# MAGIC standard_response_text IN (
# MAGIC   '1/2 Fixture Bay',
# MAGIC   '1/2 In-Aisle Promo Bay',
# MAGIC   '1/2 In-Aisle Promo Bay Shelf',
# MAGIC   '1/4 In-Aisle Promo Bay Shelf',
# MAGIC   'Fixture Full Bay',
# MAGIC   'In-Aisle Promo Bay Shelf',
# MAGIC   'Stock Merchandised Off Shelf - Other Location',
# MAGIC   '1/2 Fixture Shelf',
# MAGIC   '1/4 Fixture Shelf'
# MAGIC )
# MAGIC GROUP BY standard_response_text
...
# MAGIC where response_id = '230095913'
# MAGIC
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT standard_response_text, standard_response_cd, count(*) FROM acosta_retail_analytics_im.vw_ds_intervention_input_nars
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC   '1/4 Fixture Shelf'
# MAGIC )
# MAGIC GROUP BY standard_response_text, standard_response_cd
# MAGIC ORDER BY standard_response_text, standard_response_cd
...
# MAGIC mdm_holding_id = 71  -- walmart
# MAGIC and
# MAGIC mdm_client_id = 17351  -- everymanjack
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT standard_response_text, count(*) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC -- objective_typ='DLA'
# MAGIC and
# MAGIC standard_response_text = "Pallet/MU Wrap"
# MAGIC ORDER BY mdm_banner_id

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT standard_response_text, count(*) FROM acosta_retail_analytics_im.vw_ds_intervention_input_nars
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC and
# MAGIC standard_response_text = "Pallet/MU Wrap"
# MAGIC ORDER BY mdm_banner_id, call_date, response_id
...
# MAGIC call_date >= '2024-01-01'
# MAGIC and
# MAGIC standard_response_text like "%MU Wrap%"
# MAGIC GROUP BY standard_response_text
# MAGIC ORDER BY standard_response_text
...
# MAGIC and
# MAGIC standard_response_text IN (
# MAGIC   "Promotional SEL's Sited On Shelf",
# MAGIC   "Promotional SEL's Sited Off shelf",
# MAGIC   'HO Promotion Made Compliant – Merchandised Stock',
# MAGIC   'n-Aisle Promo Bay - Confectionery',
# MAGIC   'Pallet/MU Wrap',
# MAGIC   '1/2 Fixture Bay',
# MAGIC   '1/2 In-Aisle Promo Bay',
# MAGIC   '1/2 In-Aisle Promo Bay Shelf',
...
# MAGIC --   '1/4 Fixture Shelf',
# MAGIC --   'Fixture Shelf',
# MAGIC --   'LAD - 1/2 Gondola End Shelf'
# MAGIC -- )
# MAGIC GROUP BY standard_response_text
# MAGIC ORDER BY standard_response_text
...
# MAGIC %sql
# MAGIC
# MAGIC desc tescopartnertoolkit_tesco_nestlecore_uk_dv.vw_latest_sat_epos_summary

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SELECT sum(pos_amt) FROM tescopartnertoolkit_tesco_nestlecore_uk_dv.vw_latest_sat_epos_summary
# MAGIC where
# MAGIC retailer_item_id = '89629941'
# MAGIC AND
# MAGIC sales_dt >= '2024-03-01'
# MAGIC AND
# MAGIC sales_dt <= '2024-03-31'

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SELECT standard_response_text, sum(total_impact) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC coalesce(mdm_banner_id, -1) = 7746 -- Tesco
# MAGIC AND
# MAGIC epos_retailer_item_id = '89629941'
# MAGIC AND
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT sum(total_impact) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC call_date <= '2024-03-31'
# MAGIC AND
# MAGIC standard_response_text <> "Display Built"
# MAGIC AND
# MAGIC standard_response_text <> "Display Maintained"
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT sum(total_impact), sum(total_qimpact) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
def get_total_measurement_effect(client_id, holding_id, banner_id, start_date, end_date):
    query = f"""  
          SELECT
          -- mdm_country_nm,
          -- mdm_holding_nm,
...
response_df = get_response_data_from_view(client_id, holding_id, banner_id, '2021-08-29', '2022-12-31')
...
measurement_df = get_measurement_effect(client_id, holding_id, banner_id, '2021-08-29', '2022-12-31')
...
measured_df_temp = get_measured_effect(client_id, holding_id, banner_id, '2021-08-29', '2022-12-31')
print(measured_df_temp.cache().count())

# COMMAND ----------

measured_df = get_measured_effect(client_id, holding_id, banner_id, '2021-06-01', '2022-12-31')
...
measured_df_filtered_posttest = measured_df_filtered.where(pyf.col("call_date") >= '2021-09-01')

# COMMAND ----------

display(measured_df_filtered_posttest)
...
measured_df_filtered_pretest = measured_df_filtered.where(pyf.col("call_date") < '2021-09-01')

# COMMAND ----------

display(measured_df_filtered_pretest)
