...
# MAGIC objective_typ
# MAGIC FROM
# MAGIC acosta_retail_analytics_im.interventions_parameters
...
# MAGIC where mdm_client_id = 259 -- Crown Prince Inc
...
# MAGIC
# MAGIC SELECT * FROM acosta_retail_analytics_im.vw_ds_intervention_input_nars
# MAGIC where mdm_client_id = 1043 -- Hopkinsville Milling Co.
# MAGIC order by call_date
...
# MAGIC
# MAGIC SELECT * FROM acosta_retail_analytics_im.vw_ds_intervention_input_nars
# MAGIC where mdm_client_id = 1344 -- Seafood America LLC
# MAGIC order by call_date
...
holding_id = 2596 # Walmart Canada
banner_id = -1  # default
...
# MAGIC where retailer_id = 2596 -- Walmart Canada
...
# MAGIC
# MAGIC SELECT * FROM nars_raw.dpau -- Need to look at dpau.shelfcode
# MAGIC where retailer_id = 71 -- Walmart
...
# Results from 2021-03-29

# 2020-11: total_intervention_effect = 241197.19 total_impact = $802376.85
# 2020-12: total_intervention_effect = 200886.45 total_impact = $693114.66
# 2021-01: total_intervention_effect = 232112.04 total_impact = $728586.77
...
# 2020-11: total_intervention_effect = 12613.82 total_impact = $91815.62
# 2020-12: total_intervention_effect =  7132.33 total_impact = $55581.13
# 2021-01: total_intervention_effect = 11462.11 total_impact = $91173.45
...
# 2020-11: total_intervention_effect = 793942.43 total_impact = $5924545.02
# 2020-12: total_intervention_effect = 605923.57 total_impact = $4792003.44
# 2021-01: total_intervention_effect = 436031.08 total_impact = $3082559.35
...
# MAGIC %md
# MAGIC
# MAGIC #### WM Georgia Pacific's numbers do look a bit odd from Nov 2020 to Jan 2021; so investigate further

# COMMAND ----------

country_id = 1  # US
client_id = 417 # GeorgiaPacific
holding_id = 71 # Walmart
banner_id = -1  # default

# COMMAND ----------

df_sql_query_acosta_retail_analytics_im10 = """
  SELECT
  mdm_country_nm,
  mdm_holding_nm,
  mdm_banner_nm,
  ...
  coalesce(mdm_banner_id, -1) = {banner_id} AND
  (
      call_date like '2020-10%' OR
      call_date like '2020-11%' OR
      call_date like '2020-12%' OR
      call_date like '2021-01%' OR
...
df_acosta_retail_analytics_im10 = spark.sql(df_sql_query_acosta_retail_analytics_im10)
display(df_acosta_retail_analytics_im10)

# COMMAND ----------

df_sql_query_acosta_retail_analytics_im11 = """
  SELECT *,
  substr(call_date, 1, 7) AS call_month
  FROM 
  acosta_retail_analytics_im.ds_intervention_summary
...
df_acosta_retail_analytics_im11 = spark.sql(df_sql_query_acosta_retail_analytics_im11)
display(df_acosta_retail_analytics_im11)
