...
# MAGIC %sql
# MAGIC desc msd_morrisons_kraftheinz_uk_dv.vw_latest_sat_epos_summary

# COMMAND ----------

# MAGIC %sql
# MAGIC select sales_dt, count(*) from msd_morrisons_kraftheinz_uk_dv.vw_latest_sat_epos_summary_ivm_temp
...
# MAGIC %sql
# MAGIC select * from msd_morrisons_kraftheinz_uk_dv.vw_latest_sat_epos_summary_ivm_temp
...
# MAGIC %sql
# MAGIC select count(*) from msd_morrisons_kraftheinz_uk_dv.vw_latest_sat_epos_summary
...
# MAGIC %sql
# MAGIC select count(*) from msd_morrisons_kraftheinz_uk_dv.vw_latest_sat_epos_summary_ivm_temp
# MAGIC where sales_dt >= '2023-11-30'
# MAGIC and sales_dt <= '2025-05-29'
...
# MAGIC and
# MAGIC mdm_client_id = 16319 -- Kraft Heinz UK
# MAGIC and
