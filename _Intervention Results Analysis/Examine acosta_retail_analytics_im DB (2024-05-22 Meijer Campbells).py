...
# MAGIC and
# MAGIC mdm_holding_id = 173 -- Meijer
# MAGIC and
...
# MAGIC %sql
# MAGIC
# MAGIC select distinct mdm_client_id, standard_response_cd, standard_response_text, intervention_rank, intervention_group, intervention_start_day, intervention_end_day, actionable_flg from acosta_retail_analytics_im.interventions_parameters
# MAGIC where
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_holding_id = 173 -- meijer
...
# MAGIC %sql
# MAGIC
# MAGIC select distinct mdm_client_id, standard_response_cd, standard_response_text, intervention_rank, intervention_group from acosta_retail_analytics_im.vw_ds_intervention_input_nars
# MAGIC where
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_holding_id = 173 -- Meijer
...
# MAGIC %sql
# MAGIC
# MAGIC show tables in retail_alert_meijer_rbusa_us_im

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC desc retail_alert_meijer_rbusa_us_im.loess_forecast_baseline_unit_upc

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC select * from retail_alert_meijer_rbusa_us_im.loess_forecast_baseline_unit_upc 
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT * FROM vendornet_meijer_rbusa_us_dv.vw_latest_sat_epos_summary

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SELECT sales_dt, count(*) FROM vendornet_meijer_rbusa_us_dv.vw_latest_sat_epos_summary
