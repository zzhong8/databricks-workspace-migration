...
# MAGIC %sql
# MAGIC
# MAGIC desc retaillink_asda_johnsonandjohnson_uk_dv.vw_latest_sat_epos_summary

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC desc tescopartnertoolkit_tesco_johnsonandjohnson_uk_dv.vw_latest_sat_epos_summary
