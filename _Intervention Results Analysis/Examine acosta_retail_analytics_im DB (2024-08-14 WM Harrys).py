...
# MAGIC and mdm_client_id = 16540 -- Harrys Inc
# MAGIC and mdm_holding_id = 71 -- Walmart
# MAGIC and coalesce(mdm_banner_id, -1) = -1 -- default
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT objective_typ, call_date, count(*), sum(total_intervention_effect), sum(total_impact) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_client_id = 882 -- Danone
...
# MAGIC and
# MAGIC call_date >= '2023-10-01'
# MAGIC group by objective_typ, call_date
# MAGIC order by objective_typ, call_date
