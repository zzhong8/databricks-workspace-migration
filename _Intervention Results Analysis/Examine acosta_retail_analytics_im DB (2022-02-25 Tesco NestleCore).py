...
# MAGIC %sql
# MAGIC
# MAGIC SELECT distinct call_date FROM acosta_retail_analytics_im.vw_ds_intervention_input_nars
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC mdm_client_id = 16320 -- Nestle UK
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT distinct mdm_client_id, mdm_holding_id, mdm_banner_id, call_date FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC objective_typ = 'Opportunity'
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT distinct mdm_client_id, mdm_holding_id, mdm_banner_id FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 30 -- UK
# MAGIC and
# MAGIC objective_typ = 'Opportunity'
...
# MAGIC %sql
# MAGIC
# MAGIC select distinct standard_response_cd, standard_response_text from
# MAGIC acosta_retail_analytics_im.interventions_parameters
...
# MAGIC %sql
# MAGIC
# MAGIC show tables in tesco_nestlecore_uk_dv
...
# MAGIC %sql
# MAGIC
# MAGIC desc tesco_nestlecore_uk_dv.sat_link_epos_summary
...
# MAGIC
# MAGIC SELECT
# MAGIC       HRI.RETAILER_ITEM_ID,
# MAGIC       HOU.ORGANIZATION_UNIT_NUM,
# MAGIC       VSLES.SALES_DT,
# MAGIC       VSLES.POS_ITEM_QTY,
# MAGIC       VSLES.POS_AMT,
# MAGIC       VSLES.ON_HAND_INVENTORY_QTY,
# MAGIC       VSLES.POS_AMT / VSLES.POS_ITEM_QTY AS UNIT_PRICE
# MAGIC    FROM tesco_nestlecore_uk_dv.vw_sat_link_epos_summary VSLES
# MAGIC    LEFT OUTER JOIN tesco_nestlecore_uk_dv.hub_retailer_item HRI
# MAGIC         ON HRI.HUB_RETAILER_ITEM_HK = VSLES.HUB_RETAILER_ITEM_HK
# MAGIC    LEFT OUTER JOIN tesco_nestlecore_uk_dv.hub_organization_unit HOU
# MAGIC         ON HOU.HUB_ORGANIZATION_UNIT_HK = VSLES.HUB_ORGANIZATION_UNIT_HK
