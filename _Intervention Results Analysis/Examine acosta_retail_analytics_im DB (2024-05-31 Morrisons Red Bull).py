...
# MAGIC order by mdm_country_id, mdm_holding_id, mdm_client_id, mdm_holding_id

# COMMAND ----------

# MAGIC %sql
# MAGIC desc msd_morrisons_redbull_uk_dv.vw_latest_sat_epos_summary

# COMMAND ----------

# MAGIC %sql
# MAGIC select sales_dt, organization_unit_num, retailer_item_id, count(*) from msd_morrisons_redbull_uk_dv.vw_latest_sat_epos_summary_ivm_temp
...
# MAGIC %sql
# MAGIC select sales_dt, count(*) from msd_morrisons_redbull_uk_dv.vw_latest_sat_epos_summary_ivm_temp
...
# MAGIC %sql
# MAGIC select * from msd_morrisons_redbull_uk_dv.vw_latest_sat_epos_summary_ivm_temp
...
# MAGIC %sql
# MAGIC select count(*) from msd_morrisons_redbull_uk_dv.vw_latest_sat_epos_summary
...
# MAGIC %sql
# MAGIC select count(*) from msd_morrisons_redbull_uk_dv.vw_latest_sat_epos_summary_ivm_temp
# MAGIC where sales_dt >= '2023-11-30'
# MAGIC and sales_dt <= '2025-05-29'
...
# MAGIC and
# MAGIC mdm_client_id = 17687	-- Red Bull UK
# MAGIC and
...
# MAGIC %sql
# MAGIC
# MAGIC select mdm_client_id, mdm_client_nm, count(*) from acosta_retail_analytics_im.ds_intervention_audit_raw_temp_msdfix_drp_aftr_20240531
# MAGIC group by mdm_client_id, mdm_client_nm
# MAGIC order by mdm_client_id, mdm_client_nm
