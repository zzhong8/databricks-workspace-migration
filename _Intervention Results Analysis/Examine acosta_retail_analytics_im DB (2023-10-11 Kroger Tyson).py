...
# MAGIC and 
# MAGIC mdm_client_id = 642 -- Tyson Foods
# MAGIC and
...
# MAGIC coalesce(mdm_banner_id, -1) = -1 -- default
# MAGIC AND
# MAGIC store_acosta_number in (24622, 24685, 24794, 1637515)

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC SELECT count(response_id) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_client_id = 642 -- Tyson Foods
...
# MAGIC %sql
# MAGIC
# MAGIC SELECT store_acosta_number, epos_organization_unit_num, count(response_id) FROM acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_client_id = 642 -- Tyson Foods
...
# MAGIC coalesce(mdm_banner_id, -1) = -1 -- default
# MAGIC group by 
# MAGIC store_acosta_number, epos_organization_unit_num
# MAGIC ORDER BY
# MAGIC store_acosta_number, epos_organization_unit_num
