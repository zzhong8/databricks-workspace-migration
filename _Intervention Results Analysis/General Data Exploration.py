...
# MAGIC channel_id,
# MAGIC channel_description,
# MAGIC holding_id,
# MAGIC holding_description,
# MAGIC subbanner_id,
# MAGIC subbanner_description,
# MAGIC banner_id,
# MAGIC banner_description,
# MAGIC division_id,
# MAGIC division_description
# MAGIC from
# MAGIC acosta_retail_analytics_im.vw_dimension_store
# MAGIC where holding_id = 71
...
# MAGIC select
# MAGIC s.channel_id,
# MAGIC s.channel_description,
# MAGIC s.holding_id,
# MAGIC s.holding_description,
# MAGIC q.client_id,
# MAGIC client.description as client_description,
# MAGIC c.calendar_key,
# MAGIC DAYOFWEEK(to_date(cast(c.calendar_key as string) , 'yyyyMMdd')) - 1 as day_of_week, 
# MAGIC qr.response
# MAGIC from
...
# MAGIC join acosta_retail_analytics_im.vw_dimension_store s on c.store_id = s.store_id
# MAGIC join acosta_retail_analytics_im.vw_dimension_client client on q.client_id = client.client_id
# MAGIC where
# MAGIC q.question_type = 'Data Led Alerts'
# MAGIC and
# MAGIC q.client_id = 259 -- Crown Prince
...
# MAGIC q.question_type = 'Data Led Alerts'
# MAGIC and
# MAGIC q.client_id = 1344 -- Seafood America
# MAGIC order by c.calendar_key
...
# MAGIC q.question_type = 'Data Led Alerts'
# MAGIC and
# MAGIC q.client_id = 1043 -- Hopkinsville Milling
# MAGIC order by c.calendar_key
...
# MAGIC %sql
# MAGIC
# MAGIC select * from bobv2.reachetl_rapidresponse_companythresholds
# MAGIC where CompanyId = '577'
...
# MAGIC %sql
# MAGIC
# MAGIC select * from bobv2.lkp_ProductGroup
# MAGIC where lkp_ProductGroupId in (4559, 4560, 4561)
...
# MAGIC
# MAGIC select * from bobv2.lkp_ProductGroup
# MAGIC where lkp_ProductGroupId in (3862, 3863, 3864)
