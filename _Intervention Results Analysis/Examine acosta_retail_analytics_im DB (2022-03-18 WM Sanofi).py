...
# MAGIC %sql
# MAGIC
# MAGIC SELECT * FROM nars_raw.dpau where retailer_id = 16269
...
# MAGIC and
# MAGIC mdm_client_id = 16269 -- Danone
# MAGIC and
...
# MAGIC mdm_country_id = 1 -- US
# MAGIC and
# MAGIC mdm_client_id = 16269 -- Sanofi
# MAGIC and
# MAGIC mdm_holding_id = 71 -- Walmart
# MAGIC and
# MAGIC coalesce(mdm_banner_id, -1) = -1 -- default
...
# MAGIC and
# MAGIC vdiin.mdm_client_id = 16269 -- Sanofi
# MAGIC and
