...
# MAGIC
# MAGIC select distinct intervention_end_day FROM interventions_parameters
...
# MAGIC %sql
# MAGIC
# MAGIC select sales_dt, count(*) from retail_alert_asda_nestlecore_uk_im.vw_drfe_forecast_baseline_unit
...
# MAGIC USE acosta_retail_analytics_im;
# MAGIC
# MAGIC select call_date, sum(total_intervention_effect), sum(total_impact) from ds_intervention_summary
# MAGIC    WHERE mdm_holding_id = 3257
# MAGIC    AND mdm_client_id = 16320
# MAGIC    AND mdm_country_id = 30
# MAGIC    AND mdm_banner_id = 7743
# MAGIC    AND call_date >= '2023-08-01'
...
# MAGIC USE acosta_retail_analytics_im;
# MAGIC
# MAGIC select call_date, sum(total_intervention_effect), sum(total_intervention_effect) from ds_intervention_summary
# MAGIC    WHERE mdm_holding_id = 3257
# MAGIC    AND mdm_client_id = 16320
# MAGIC    AND mdm_country_id = 30
...
# MAGIC 179013374,
# MAGIC 179226782,
# MAGIC 179319979) -- 180437429, 180725425, 180761928, 182055225, 182739614, 182742776, 185186064, 185200844, 186028218, 187230638, 187869419, 187900935, 188220619, 198579395, 198579396, 198652650, 199770577)
