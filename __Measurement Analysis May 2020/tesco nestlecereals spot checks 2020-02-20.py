...
# data_vault_data2 = data_vault_data2.where(col("RETAILER_ITEM_ID") == 51565653)
...
data_vault_data3 = data_vault_data.where(col("INTERVENTION_TYPE") == 'Additional Display - Half Ladder Rack')
