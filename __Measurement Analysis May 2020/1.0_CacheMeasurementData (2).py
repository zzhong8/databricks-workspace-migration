...
# MAGIC %sql
# MAGIC select mdm_holding_id, mdm_client_id, mdm_client_nm, min(call_date), max(call_date) from acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC   mdm_country_id = 1 AND
# MAGIC   mdm_holding_id = 71 AND
# MAGIC   coalesce(mdm_banner_id, -1) = -1 and
# MAGIC   mdm_client_id in (460, 851, 869, 882, 9663, 13543, 16161, 16269, 16540)
# MAGIC group by mdm_holding_id, mdm_client_id, mdm_client_nm
# MAGIC order by mdm_holding_id, mdm_client_id, mdm_client_nm
...
# MAGIC %sql
# MAGIC select mdm_client_id, mdm_banner_id, mdm_client_nm, min(call_date), max(call_date) from acosta_retail_analytics_im.ds_intervention_summary
# MAGIC where
# MAGIC   mdm_country_id = 30
# MAGIC group by mdm_client_id, mdm_client_nm, mdm_banner_id
# MAGIC order by mdm_client_id, mdm_client_nm, mdm_banner_id
