...
data_vault_data = spark.sql(sql_statement)
...
data_vault_data1 = data_vault_data.where(col("SALES_DT") >= lit("2019-06-30"))
data_vault_data1 = data_vault_data1.where(col("SALES_DT") <= lit("2019-06-30"))

# COMMAND ----------

# data_vault_data1 = data_vault_data1.where(col("RETAILER_ITEM_ID") == lit("51169241"))

# COMMAND ----------

data_vault_data1 = data_vault_data1.where(col("ORGANIZATION_UNIT_NUM") == lit("2547"))
