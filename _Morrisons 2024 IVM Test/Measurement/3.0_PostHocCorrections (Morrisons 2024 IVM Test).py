...
# MAGIC %sql
# MAGIC create table if not exists acosta_retail_analytics_im.ds_intervention_summary_temp_msdfix_drp_aftr_20240531
# MAGIC (
...
# MAGIC LOCATION 'abfss://data@eus2psag2dpcoredatalake.dfs.core.windows.net/informationmart/acosta_retail_report/ds_intervention_summary_temp_msdfix_drp_aftr_20240531'
...
completed_response_ids = spark.sql(f'''
    ...
    from acosta_retail_analytics_im.ds_intervention_summary_temp_msdfix_drp_aftr_20240531
...
delta_summary_table = DeltaTable\
    .forName(spark, 'acosta_retail_analytics_im.ds_intervention_summary_temp_msdfix_drp_aftr_20240531')\
    .alias('source')
