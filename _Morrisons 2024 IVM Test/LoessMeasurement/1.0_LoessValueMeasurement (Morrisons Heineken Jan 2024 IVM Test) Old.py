...
def get_pos_data(pos_database: str, min_date: str, spark):
    ...
    try:
        ...
        df = spark.sql(f"select * from {pos_database}.vw_latest_sat_epos_summary_ivm_temp") # Temp change
...
delta_summary_table.merge(
    ...
    source.mdm_client_id = update.mdm_client_id a# Databricks notebook source
%md
...
# MAGIC %sql
# MAGIC create table if not exists acosta_retail_analytics_im.ds_intervention_audit_raw_temp_msdfix_drp_aftr_20240531
# MAGIC (
# MAGIC   mdm_country_id  Int,
# MAGIC   mdm_holding_id  Int,
# MAGIC   mdm_banner_id Int,
...
# MAGIC USING delta
# MAGIC tblproperties (delta.autooptimize.optimizewrite = true, delta.autooptimize.autocompact = true)
# MAGIC LOCATION 'abfss://data@eus2psag2dpcoredatalake.dfs.core.windows.net/informationmart/acosta_retail_report/ds_intervention_audit_raw_temp_msdfix_drp_aftr_20240531'

# COMMAND ----------

# Save the data
df_stats.write.format("delta").mode("append").insertInto(
    "acosta_retail_analytics_im.ds_intervention_audit_raw_temp_msdfix_drp_aftr_20240531"
)
...
df_summary_table = df_summary_table.alias("update")
delta_summary_table = DeltaTable.forName(
    spark, "acosta_retail_analytics_im.ds_intervention_summary_temp_msdfix_drp_aftr_20240531"
).alias("source")
delta_summary_table.merge(
    df_summary_table,
    """
