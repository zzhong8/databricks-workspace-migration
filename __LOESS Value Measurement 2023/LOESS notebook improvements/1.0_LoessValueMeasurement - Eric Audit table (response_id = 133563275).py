...
try:
    upc_itemid_mapper = spark.sql(
        f"""
        select
            distinct t1.HUB_RETAILER_ITEM_HK,
            t1.UPC
...
#append the duplicative interventions here with status cude "4 Duplicative Response"
...
# df_intervention_duplicative = df_intervention_duplicative.withColumn("status_code", pyf.lit("4 Duplicative response"))
