...
data_vault_data2 = data_vault_data.where((col("SALES_DT") == lit("2019-11-10")) & (col("RETAILER_ITEM_ID") <= 4000000))
...
data_vault_data3 = data_vault_data.where((col("SALES_DT") == lit("2019-11-08")) & (col("RETAILER_ITEM_ID") <= 4000000))
