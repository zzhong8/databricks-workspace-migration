...
# import only recent data (currently set to most recent 2 months)
...
#     call_date Date
# )
# -- Not creating a DELTA table as we would like to overwrite partitions.
# USING org.apache.spark.sql.parquet
# PARTITIONED BY (mdm_country_id, mdm_holding_id, mdm_banner_id, mdm_client_id, call_date)
# OPTIONS (
#     `compression` 'snappy',
#     path 'adl://azueus2prdadlsdatalake.azuredatalakestore.net/informationmart/adhoc_acosta_retail_report/ds_intervention_summary'
# );

# COMMAND ----------

# %sql
# create table if not exists default.ds_intervention_summary
# (
#     mdm_country_nm  String,
#     mdm_holding_nm  String,
#     mdm_banner_nm string,
...
#     from default.ds_intervention_summary
...
#     .write\
#     .mode('overwrite')\
#     .insertInto('default.ds_intervention_summary', overwrite=True)
