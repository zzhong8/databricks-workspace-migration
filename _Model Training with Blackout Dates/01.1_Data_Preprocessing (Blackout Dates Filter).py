...
# data = data.where((pyf.col("SALES_DT") < pyf.lit("2020-03-01")) | (pyf.col("SALES_DT") > pyf.lit("2020-03-31"))) # If abnormal sales trends seen for 4 weeks
# data = data.where((pyf.col("SALES_DT") < pyf.lit("2020-03-01")) | (pyf.col("SALES_DT") > pyf.lit("2020-04-15"))) # If abnormal sales trends seen for 6 weeks
# data = data.where((pyf.col("SALES_DT") < pyf.lit("2020-03-01")) | (pyf.col("SALES_DT") > pyf.lit("2020-04-30"))) # If abnormal sales trends seen for 8 weeks
data = data.where((pyf.col("SALES_DT") < pyf.lit("2020-03-12")) | (pyf.col("SALES_DT") > pyf.lit("2020-03-21"))) # Restrict Data Size for Premier retailers
# data = data.where(pyf.col("SALES_DT") > pyf.lit("2018-12-31")) # Restrict Data Size for Walmart Starbucks
# data = data.where(pyf.col("SALES_DT") >= pyf.lit("2019-11-11")) # Restrict Data Size for Asda Premier
# data = data.where((pyf.col("SALES_DT") >= pyf.lit("2020-04-25")) & (pyf.col("SALES_DT") <= pyf.lit("2020-09-10"))) # Temp Solution
