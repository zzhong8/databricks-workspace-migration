...
sql_statement = """
SELECT * FROM walmart_clorox_us_retail_alert_im.drfe_forecast_baseline_unit
"""
df = spark.sql(sql_statement)
...
sql_statement3 = """
SELECT * FROM retail_forecast_engine.drfe_forecast_baseline_unit
WHERE HUB_ORGANIZATION_UNIT_HK == '9a1158154dfa42caddbd0694a4e9bdc8'
AND HUB_RETAILER_ITEM_HK == 'e5ed371c9bbcf7d42fd152753eabafd2'
"""
df3 = spark.sql(sql_statement3)
