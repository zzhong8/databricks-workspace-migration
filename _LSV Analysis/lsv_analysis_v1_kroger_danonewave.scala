...
// MAGIC   LOST_SALES_AMT >= 7) num_slow_sales_alerts_using_old_lsv,
// MAGIC
// MAGIC (select
// MAGIC   count(*)
// MAGIC from danonewave_drt_us_team_alerts_im.vw_retail_alerts_on_shelf_availability
...
// MAGIC   SALES_DT between date('2020-06-01') and date('2020-09-05') and
// MAGIC   ALERT_MESSAGE_DESC = 'Slow Sales' and
// MAGIC   LOST_SALES_AMT >= 7) num_slow_sales_alerts_using_old_lsv2
// MAGIC
// MAGIC """
// MAGIC
// MAGIC results = spark.sql(sqlCountOsaAlerts)
...
c%sql
select * from kroger_danonewave_us_dv.SAT_LINK_BOH 
