...
for i in list: 
    ...
    where
      ...
      LOST_SALES_AMT >= 20) num_slow_sales_alerts_using_old_lsv,
    ...
    where
      SALES_DT between date('2020-06-01') and date('2020-09-05') and
      ALERT_MESSAGE_DESC <> 'Slow Sales' and
      LOST_SALES_AMT >= 20) num_non_slow_sales_alerts_using_old_lsv,
    ...
    where
      SALES_DT between date('2020-06-01') and date('2020-09-05') and
      ALERT_MESSAGE_DESC = 'Slow Sales' and
      LOST_SALES_AMT >= 20) num_osa_alerts_using_new_lsv
