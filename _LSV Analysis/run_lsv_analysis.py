...
#   'walmart_campbells_ca',
#   'walmart_catelli_ca',
#   'walmart_kens_us',
#   'walmart_labatt_ca',
#   'walmart_lego_ca',
#   'walmart_milos_us',
#   'walmart_minutemaidcompany_us',
#   'walmart_rbhealth_ca',
#   'walmart_rbusahealth_us',
#   'walmart_rbusahygiene_us',
#   'walmart_smuckers_ca',
#   'walmart_starbucks_us',
#   'walmart_truco_ca',
#   'walmart_voortman_ca',
# ] 
...
# # Python3 code to iterate over a list 
# list = [
#   'walmart_gpconsumerproductsoperation_us'
# ] 
...
for i in list: 
    ...
    where
      ...
      LOST_SALES_AMT >= 10) num_slow_sales_alerts_using_old_lsv,
    ...
    where
      SALES_DT between date('2020-06-01') and date('2020-09-05') and
      ALERT_MESSAGE_DESC = 'Slow Sales' and
      LOST_SALES_AMT >= 10) num_osa_alerts_using_new_lsv
