...
walmart_campbellssnack_us_retail_alert_im.alert_inventory_cleanup

// COMMAND ----------

// MAGIC %sql
// MAGIC desc retail_alert_walmart_stonyfieldfarm_us_im.lost_sales_value

// COMMAND ----------

// MAGIC %sql
// MAGIC desc retail_alert_walmart_stonyfieldfarm_us_im.vw_latest_lost_sales_value

// COMMAND ----------

// MAGIC %sql
// MAGIC desc retaillink_walmart_stonyfieldfarm_us_dv.vw_latest_sat_epos_summary

// COMMAND ----------

// MAGIC %sql
// MAGIC use retail_alert_walmart_stonyfieldfarm_us_im;
// MAGIC show tables

// COMMAND ----------

// MAGIC %sql
// MAGIC desc retail_alert_walmart_stonyfieldfarm_us_im.vw_fct_daily_ty_ly_sales

// COMMAND ----------

// MAGIC %sql
// MAGIC desc retail_alert_walmart_stonyfieldfarm_us_im.alert_on_shelf_availability

// COMMAND ----------

// MAGIC %sql
// MAGIC desc retail_alert_walmart_stonyfieldfarm_us_im.vw_latest_alert_on_shelf_availability
...
// MAGIC
// MAGIC     FROM walmart_campbellssnack_us_dv.vw_sat_link_epos_summary vw_sat_lnk 
// MAGIC     INNER JOIN walmart_campbellssnack_us_dv.vw_sat_retailer_item_unit_price vw_sat_unt_prc
...
// MAGIC     
// MAGIC     INNER JOIN walmart_campbellssnack_us_retail_alert_im.DRFE_FORECAST_BASELINE_UNIT fcst_unt 
...
WITH CALC_LSV AS 
   (
    ...
    FROM walmart_campbellssnack_us_dv.vw_sat_link_epos_summary vw_sat_lnk 
    INNER JOIN walmart_campbellssnack_us_dv.vw_sat_retailer_item_unit_price vw_sat_unt_prc
    ...
    INNER JOIN walmart_campbellssnack_us_retail_alert_im.DRFE_FORECAST_BASELINE_UNIT fcst_unt 
...
spark.sql(viewDdl).createOrReplaceTempView("tmp_vw_walmart_campbellssnack_lost_sales_value_new")
...
// MAGIC %sql
// MAGIC select * from tmp_vw_walmart_campbellssnack_lost_sales_value_new
// MAGIC where
// MAGIC SALES_DT = date('2020-09-01')
// MAGIC limit 100
...
// MAGIC from
// MAGIC
// MAGIC walmart_campbellssnack_us_retail_alert_im.LOST_SALES_VALUE old_lsv,
// MAGIC tmp_vw_walmart_campbellssnack_lost_sales_value_new new_lsv
// MAGIC
// MAGIC where
// MAGIC
...
// MAGIC from walmart_campbellssnack_us_retail_alert_im.alert_on_shelf_availability
// MAGIC where
// MAGIC sales_dt = date('2020-09-01')
...
FROM walmart_campbellssnack_us_dv.vw_sat_link_epos_summary sles

INNER JOIN (select * from tmp_vw_walmart_campbellssnack_lost_sales_value_new ) llsv -- Pulling data from the new LSV derivation TMP View
...
INNER JOIN (select * from tmp_vw_walmart_campbellssnack_lost_sales_value_new ) adsd -- Pulling data from the new LSV derivation TMP View
...
"""
spark.sql(sqlOsaSlowSales).createOrReplaceTempView("tmp_vw_walmart_campbellssnack_alert_on_shelf_availability_new")
...
// MAGIC   ALERT_MESSAGE_DESC,
// MAGIC   count(*)
// MAGIC from tmp_vw_walmart_campbellssnack_alert_on_shelf_availability_new
// MAGIC where
// MAGIC   SALES_DT between date('2020-06-01') and date('2020-09-05') and
// MAGIC   ALERT_MESSAGE_DESC = 'Slow Sales' and
// MAGIC   LOST_SALES_AMT >= 7
...
// MAGIC from walmart_campbellssnack_us_retail_alert_im.alert_on_shelf_availability
// MAGIC where
// MAGIC   SALES_DT between date('2019-06-01') and date('2020-09-05') 
// MAGIC   and ALERT_MESSAGE_DESC <> 'Slow Sales'
// MAGIC group by 
// MAGIC   ALERT_MESSAGE_DESC
// MAGIC order by
...
// where
//   SALES_DT between date('2019-01-01') and date('2020-09-05') 
