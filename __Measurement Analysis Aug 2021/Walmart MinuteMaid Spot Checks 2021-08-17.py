...
data_vault_data2 = data_vault_data2.where(col("RETAILER_ITEM_ID") == 52162304)
# data_vault_data2 = data_vault_data2.where(col("RETAILER_ITEM_ID") == 57605428)
...
data2019 = data_vault_data2.where((col("SALES_DT") <= lit("2019-12-31")) & (col("SALES_DT") >= lit("2019-01-01")))
data2019.count()
...
data1 = data_vault_data2.where((col("SALES_DT") <= lit("2019-10-06")) & (col("SALES_DT") >= lit("2019-09-09")))
...
data_vault_data3 = data_vault_data.where(col("INTERVENTION_TYPE") == 'Presell')
# data_vault_data3 = data_vault_data
data_vault_data3 = data_vault_data3.where(col("RETAILER_ITEM_ID") == 52162304)

data_vault_data3 = data_vault_data3.withColumn('INTERVENTION_DATE', expr("date_sub(SALES_DT, DIFF_DAY)"))
data3 = data_vault_data3.where((col("INTERVENTION_DATE") <= lit("2019-10-06")) & (col("INTERVENTION_DATE") >= lit("2019-08-09")))
...
data1_interventions = data1_interventions.where(col("RETAILER_ITEM_ID") == 52162304)
data1_interventions = data1_interventions.where((col("SALES_DT") <= lit("2019-10-06")) & (col("SALES_DT") >= lit("2019-09-09")))
...
distinct_intervention_types = data_vault_data.select('INTERVENTION_TYPE').distinct()
...
data_vault_data5 = data_vault_data5.where(col("RETAILER_ITEM_ID") == 52162304)
...
data5_interventions = data5_interventions.where(col("RETAILER_ITEM_ID") == 52162304)
...
# combined_dre_iv_data = combined_dre_iv_data.where(col("RETAILER_ITEM_ID") == 51565653)
