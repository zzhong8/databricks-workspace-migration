...
country_id = 1  # US
client_id = 13543 # Milos
holding_id = 71 # Walmart
banner_id = -1  # default

# COMMAND ----------

df_sql_query_acosta_retail_analytics_im_milos = """
  SELECT *
  FROM 
  ...
  --total_intervention_effect >= 5 AND
  (
      call_date like '2020-08%' OR
      call_date like '2020-09%' OR
      call_date like '2020-10%' OR
      call_date like '2020-11%' OR
      call_date like '2020-12%' OR
      call_date like '2021-01%' OR
      call_date like '2021-02%' OR
...
df_acosta_retail_analytics_im_milos = spark.sql(df_sql_query_acosta_retail_analytics_im_milos)
display(df_acosta_retail_analytics_im_milos)
