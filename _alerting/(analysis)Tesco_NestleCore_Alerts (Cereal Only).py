       ...
       select
        ...
        join
          (select store_id, subbanner_id , subbanner_description , market_id , market_description 
            from acosta_UK_retail_analytics_im.vw_dimension_store where banner_id = 7746) b
        ...
        where client_id = 16320 and category_description = "Cereal") i
...
df = get_data(start_date = '2018-01-01', end_date = '2021-03-31')
display(df)
