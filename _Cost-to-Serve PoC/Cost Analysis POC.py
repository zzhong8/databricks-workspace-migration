...
# MAGIC %md
# MAGIC ### Combine all the Processes

# COMMAND ----------

# MAGIC %md
# MAGIC ##### Get the number of inventory cleanup and OSA alerts and total costs for each process for each retailer/client/country/team in the Past 3 Months
...
# MAGIC %md
# MAGIC ##### Get the total number of inventory cleanup and OSA alerts and total costs for each process for all customers in the Past 3 Months

# COMMAND ----------

# Get totals for Past 3 Months 
