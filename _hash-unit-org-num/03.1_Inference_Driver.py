...
# MAGIC %scala
# MAGIC dbutils.widgets.text("ADF_Pipeline_RunId", "", "ADF_Pipeline_RunId")

# COMMAND ----------

# MAGIC %md
# MAGIC ###Register Custom Spark Listener and Map Parameters

# COMMAND ----------

# MAGIC %scala
# MAGIC import acosta.dataplatform.monitor.sparklisteners._
# MAGIC
# MAGIC AppInsightSparkListener.registerNotebookWithLogger(dbutils.widgets.get("ADF_Pipeline_RunId"), Map(
# MAGIC   "clientName" -> dbutils.widgets.get("Retailer_Client").split('_')(1),
# MAGIC   "retailerName" -> dbutils.widgets.get("Retailer_Client").split('_')(0),
# MAGIC   "countryCode" -> dbutils.widgets.get("Retailer_Client").split('_')(2), 
# MAGIC    "pipelinePhase" -> "Forecast Drfe Load Parameters",
# MAGIC   "adlsAccountName" -> dbutils.widgets.get("ADLS_Account_Name")  
# MAGIC ))
