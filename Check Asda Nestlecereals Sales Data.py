...
data_vault_data2 = data_vault_data.where((col("SALES_DT") == lit("2019-11-10")) & (col("RETAILER_ITEM_ID") <= 10000000))
...
data_vault_data3 = data_vault_data.where((col("SALES_DT") == lit("2019-11-08")) & (col("RETAILER_ITEM_ID") <= 10000000))

# COMMAND ----------

display(data_vault_data3)

# COMMAND ----------

data_vault_data5 = data_vault_data.where((col("SALES_DT") == lit("2019-11-02")) & (col("RETAILER_ITEM_ID") <= 4000000))

# COMMAND ----------

display(data_vault_data5)

# COMMAND ----------

# data_vault_data5.coalesce(1)\
#     .write.format('com.databricks.spark.csv')\
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/asda-premier-2019-11-02-sales')

# COMMAND ----------

# data_vault_data6 = data_vault_data.where(col("SALES_DT") == lit("2019-10-26"))

# data_vault_data6.coalesce(1)\
#     .write.format('com.databricks.spark.csv')\
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/asda-premier-2019-10-26-sales')

# data_vault_data7 = data_vault_data.where(col("SALES_DT") == lit("2019-10-27"))

# data_vault_data7.coalesce(1)\
#     .write.format('com.databricks.spark.csv')\
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/asda-premier-2019-10-27-sales')

# data_vault_data8 = data_vault_data.where(col("SALES_DT") == lit("2019-09-30"))

# data_vault_data8.coalesce(1)\
#     .write.format('com.databricks.spark.csv')\
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/asda-premier-2019-09-30-sales')

# COMMAND ----------

data_vault_data9 = data_vault_data.where((col("SALES_DT") == lit("2019-09-07")) & (col("RETAILER_ITEM_ID") <= 4000000))

# COMMAND ----------

display(data_vault_data9)

# COMMAND ----------

data_vault_data10 = data_vault_data.where((col("SALES_DT") == lit("2019-08-07")) & (col("RETAILER_ITEM_ID") <= 4000000))

# COMMAND ----------

display(data_vault_data10)
