...
# MAGIC %sql
# MAGIC create table if not exists acosta_retail_analytics_im.ds_intervention_summary_20240802_asda_beiersdorf_drfe_ivm_test
# MAGIC (
...
# MAGIC LOCATION 'abfss://data@eus2psag2dpcoredatalake.dfs.core.windows.net/informationmart/acosta_retail_report/ds_intervention_summary_20240802_asda_beiersdorf_drfe_ivm_test'
...
completed_response_ids = spark.sql(f'''
    ...
    from acosta_retail_analytics_im.ds_intervention_summary_20240802_asda_beiersdorf_drfe_ivm_test
...
# MAGIC %sql
# MAGIC select count(*) from acosta_retail_analytics_im.ds_intervention_summary_20240802_asda_beiersdorf_drfe_ivm_test
...
delta_summary_table = DeltaTable\
    .forName(spark, 'acosta_retail_analytics_im.ds_intervention_summary_20240802_asda_beiersdorf_drfe_ivm_test')\
    .alias('source')
...
delta_summary_table.merge(
    ...
    source.response_id = update.response_id
    '''
