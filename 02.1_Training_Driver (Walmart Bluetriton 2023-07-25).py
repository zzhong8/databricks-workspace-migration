...
check_path_exists(PATH_RESULTS_OUTPUT, file_format='delta', errors='raise')
...
# MAGIC %sql
# MAGIC
# MAGIC ALTER TABLE delta.'dbfs:/mnt/prod-ro/artifacts/training_results/walmart/bluetritonbrands/us' SET TBLPROPERTIES (delta.targetFileSize = 134217728);

# COMMAND ----------

print(PATH_RESULTS_OUTPUT)
