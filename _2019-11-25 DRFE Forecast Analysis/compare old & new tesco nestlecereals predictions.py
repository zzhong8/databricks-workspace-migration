...
PATH_RESULTS_INPUT_OLD = '/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-10-15-sales-old-predictions'
...
PATH_RESULTS_INPUT_NEW = '/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-10-15-sales-new-predictions'
...
#     .option('header', 'true')\
#     .mode('overwrite')\
#     .save('/mnt/artifacts/hugh/tesco-nestlecereals-post-2019-10-15-predictions-comparison')
