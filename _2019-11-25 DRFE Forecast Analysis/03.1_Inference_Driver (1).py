...
sales_data_subset.columns

# COMMAND ----------

sales_data_subset.count()

# COMMAND ----------

display(sales_data_subset.where(pyf.col('POS_ITEM_QTY').isNull()))

# COMMAND ----------

sales_data_subset.where(pyf.col('POS_ITEM_QTY').isNull()).count()
