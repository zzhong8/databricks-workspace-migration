...
def read_pos_data3(source_system, retailer, client, country_code, sql_context):
    """
...
# Read POS data
data_vault_data = read_pos_data3(SOURCE_SYSTEM, RETAILER, CLIENT, COUNTRY_CODE, sqlContext).repartition('SALES_DT')

# COMMAND ----------

# Let's only look as April 2021 onwards
data = data_vault_data.where(((col("SALES_DT") < lit("2022-02-01")) & (col("SALES_DT") >= lit("2020-11-01"))) & (col("POS_ITEM_QTY") >= 5000))
...
# MAGIC and sales_dt >= '2020-11-01'
# MAGIC and sales_dt <= '2021-01-31'
# MAGIC group by 1
# MAGIC order by 1 
