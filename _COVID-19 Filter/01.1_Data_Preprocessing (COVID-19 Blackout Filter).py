...
data = data.where((pyf.col("SALES_DT") < pyf.lit("2020-03-01")) | (pyf.col("SALES_DT") > pyf.lit("2020-03-31")))
# data = data.where((pyf.col("SALES_DT") < pyf.lit("2020-03-01")) | (pyf.col("SALES_DT") > pyf.lit("2020-04-15"))) # Walmart Barilla only
